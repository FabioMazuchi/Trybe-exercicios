...
gol.speedUp();
console.log('\n========= PIZZARIA ============');
const calabreza = { flavor: 'Calabresa', slices: 6 };
const frango = { flavor: 'Frango', slices: 8 };
const pepperoni = { flavor: 'Pepperoni', slices: 8 };
const marguerita = { flavor: 'Marguerita', slices: 8 };
const palmito = { flavor: 'Palmito', slices: 8 };
const goiabadaQueijo = { flavor: 'Goiabada com Queijo', slices: 4 };
