...
def timer(string, initial_time):
    ...
    print(string)
    print(f"Tempo para a tarefa terminar: {perf_counter() - initial_time}")
...
for number in RANDOM_NUMBERS:
    main.load(number)
timer("Numeros carregados na memória principal", main_load_init_time)
...
main.clean()
timer("Clean na memóeia principal", main_clean_init_time)
...
timer(
    f"Soma na memória secundária: {secondary_sum}", secondary_get_initial_time
)
